...
#
function Show-ArubaCXException() {
    Param(
    ...
    if ($Exception.Exception.InnerException) {
        ...
        if ("AuthenticationException" -eq $exceptiontype.name) {
            ...
            Write-Warning "Try to use Connect-ArubaCX -SkipCertificateCheck for connection"
    ...
    If ($Exception.Exception.Response) {
        ...
        Write-Warning "The ArubaCX API sends an error message:"
